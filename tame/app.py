...
from steering import ADAPTIVE_STEERING as _ADAPTIVE_STEERING
...
# ``steering.ADAPTIVE_STEERING``, re-exported so its readers keep their name.
ADAPTIVE_STEERING = _ADAPTIVE_STEERING
