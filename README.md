...
| Stochastic cell fate keeps every lineage sampling its environment | The auction's exploration slot: a free, report-independent slot for a random loser on 2% of training tokens | Implemented ([#15](#phase-05--mechanism-correction)) |
